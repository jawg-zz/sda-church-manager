...
def quarterly_report():
    ...
    ss_classes = SabbathSchoolClass.query.count()
    total_ss_members = Member.query.filter_by(membership_status='active').count()

    # Active officers
    active_officers = ChurchOfficer.query.filter_by(active=True).count()
